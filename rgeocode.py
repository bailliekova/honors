...
#fipsdict=json.load(open('US_FIPS_County.JSON', 'rb'))
fipsdict=json.loads("""{ "Mississippi": {
        "Yalobusha": "161", 
        "Panola": "107", 
        "Jackson": "059", 
        "Harrison": "047", 
...
def getCountyFips(lat, lng):
	params['latlng']= ','.join([str(lat), str(lng)])
	...
	return fipsdict[state]['statefips']+ fipsdict[state][county]
